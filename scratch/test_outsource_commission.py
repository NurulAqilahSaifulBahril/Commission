...
print(f"Total basic lines: {len(out_basic_lines)}")
print(f"Total NFP rows: {len(out_nfp_rows)}")

# Filter details by month
...
print(f"Filtered basic lines for month {month}: {len(out_basic_lines_filtered)}")
print(f"Filtered NFP rows for month {month}: {len(out_nfp_rows_filtered)}")
...
print("Agent Summary Keys:", list(agent_summary.keys()))
print("Customer Summary Keys:", list(customer_summary.keys()))
if month in agent_summary:
    print(f"Agent summary rows for month {month}: {len(agent_summary[month])}")
if month in customer_summary:
    print(f"Customer summary rows for month {month}: {len(customer_summary[month])}")
    print("Sample Customer row:")
    if customer_summary[month]:
        print(customer_summary[month][0])
